...
cp ../updater/package/usr/local/bin/zenith-nvidia-check config/includes.chroot/usr/local/bin/
...
cp ../updater/package/usr/share/applications/zenith-nvidia-check.desktop config/includes.chroot/usr/share/applications/
