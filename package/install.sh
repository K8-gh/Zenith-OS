...
apt-get update
apt-get install -y xfce4-goodies xfce4-appfinder xfce4-session xfce4-workspaces xfce4-power-manager xfce4-pulseaudio-plugin xfce4-notifyd xfce4-clipman xfce4-clipman-plugin xfce4-screenshooter xfce4-taskmanager zenity
